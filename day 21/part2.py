...
for ingredient, ingredient_allergens in possible_allergens_for_ingredients.items():
    if not ingredient_allergens:
...
for allergen in allergens:
    for ingredient, ingredient_allergens in possible_allergens_for_ingredients.items():
        if allergen in ingredient_allergens:
            print(f"{ingredient},", end="")

# print(",".join(ingredients_that_cant_contain_allergens))